        ...
        <div class="card" style="margin-top: 50px">
            ...
            <div class="card-content">
                ...
                if ($upload_akte != "" && $upload_kartu_keluarga != "" && $foto_anak != "") {
                    ...
                    $queryx     =   "SELECT * FROM siswa WHERE email ='$email'";
                    ...
                    } else if ($daftar['upload_ijazah'] != "" && $daftar['upload_akte'] != "" && $daftar['upload_kartu_keluarga'] != "" && $daftar['foto_anak'] != "" && $daftar['upload_skl'] != "") {
                        echo "<div class='alert alert-warning alert-dismissable'>
                              <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        if ($upload_ijazah != "" && $upload_skl != "") {

                            if ($daftar['status_pendaftaran'] == 1) {
                                echo '<font color="#2ecc71">Ijazah dan Surat Keterangan Lulus<i class="fa fa-check"></i></font>';
                            } else if ($daftar['status_pendaftaran'] >= 2) {
                                echo '<font color="#2ecc71">Ijazah dan Surat Keterangan Lulus<i class="fa fa-check"></i></font>';
                            } else {
                                echo '<font color="#2ecc71">Ijazah dan Surat Keterangan Lulus<i class="fa fa-check"></i></font> <a href="index.php?page=7" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Ijazah dan SKL <a href="index.php?page=7" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
                    ...
                    <li>
                        ...
                        if ($foto_anak != "") {
                            ...
                            if ($daftar['status_pendaftaran'] == 1) {
                                ...
                                echo '<font color="#2ecc71">Foto anak ukuran 2R<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Foto anak ukuran 2R <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akte Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
