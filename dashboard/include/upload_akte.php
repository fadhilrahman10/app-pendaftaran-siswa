...
if (isset($_POST['upload'])) {
    ...
    if ($upload_akte != "") {
        unlink($targetfolderBase . $upload_akte);
    }
    if ($upload_kartu_keluarga != "") {
        unlink($targetfolderBase . $upload_kartu_keluarga);
    }
    ...
    if ($file_type == "application/pdf" || $file_type == "image/png" || $file_type == "image/jpeg") {
        ...
        if (move_uploaded_file($_FILES['akte']['tmp_name'], $targetfolder)) {
            ...
            $query  = "UPDATE siswa SET upload_akte='$fileNameAkte' WHERE email='$email'";
    ...
    if ($file_type2 == "application/pdf" || $file_type2 == "image/png" || $file_type2 == "image/jpeg") {
        if (move_uploaded_file($_FILES['foto2r']['tmp_name'], $targetfolder2)) {
            ...
            $query  = "UPDATE siswa SET upload_kartu_keluarga='$fileNameFoto' WHERE email='$email'";
